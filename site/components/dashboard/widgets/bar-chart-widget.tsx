...
export const BarChartWidget: ComponentFn<DashboardCatalog, "BarChartWidget"> = ({
  props,
}) => {
  const rows = toRows(props.data)
  const chartRoot = asProps<Omit<React.ComponentProps<typeof BarChart>, "ref">>(
    props.chartProps
  )
